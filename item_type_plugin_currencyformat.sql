...
,p_default_workspace_id=>9523982812558442
,p_default_application_id=>108
,p_default_id_offset=>10400341389721053
,p_default_owner=>'ALT_SCHEMA'
);
end;
/
 
prompt APPLICATION 108 - CurrencyFormat - Demo
--
-- Application Export:
--   Application:     108
--   Name:            CurrencyFormat - Demo
--   Date and Time:   17:30 Monday March 2, 2020
--   Exported By:     TIM.SCHMUHL@ORACLE.COM
--   Flashback:       0
--   Export Type:     Component Export
--   Manifest
--     PLUGIN: 6974684378912753145
--   Manifest End
--   Version:         19.2.0.00.18
--   Instance ID:     9510412946551731
--
...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(6974684378912753145)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(6974684591135753153)
,p_plugin_id=>wwv_flow_api.id(6974684378912753145)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(6974684983570753155)
,p_plugin_id=>wwv_flow_api.id(6974684378912753145)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(6974686347496753157)
,p_plugin_attribute_id=>wwv_flow_api.id(6974684983570753155)
,p_display_sequence=>10
,p_display_value=>'Left'
,p_return_value=>'Left'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(6974685910555753157)
,p_plugin_attribute_id=>wwv_flow_api.id(6974684983570753155)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(6974685410679753156)
,p_plugin_attribute_id=>wwv_flow_api.id(6974684983570753155)
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(6974687459884753170)
,p_plugin_id=>wwv_flow_api.id(6974684378912753145)
